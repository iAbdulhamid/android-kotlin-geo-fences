 ...
 */
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        // TODO: Step 7 add code to check that the user turned on their device location and ask again if they did not
    ...
    private fun foregroundAndBackgroundLocationPermissionApproved(): Boolean {
        // TODO: Step 3 replace this with code to check that the foreground and background permissions were approved
